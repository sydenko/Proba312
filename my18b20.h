...
#pragma used+
extern struct __ds18b20_scratch_pad_struct_MY
       {
       ...
       unsigned char conf_register,
                     ...
                     res3,
                     crc;
       } __ds18b20_scratch_pad_MY;

unsigned char ds18b20_select_MY(unsigned char *addr);
unsigned char ds18b20_read_spd_MY(unsigned char *addr);
float ds18b20_temperature_MY(unsigned char *addr);
unsigned char ds18b20_init_MY(unsigned char *addr,signed char temp_low,signed char temp_high,
unsigned char resolution);
#pragma used-

#pragma library my18b20.lib
